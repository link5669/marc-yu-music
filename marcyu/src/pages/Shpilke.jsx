...
import bubbe from "../assets/shp/SHP-T02v1 M02v3 Bubbe Careful Now.wav";
import tate from "../assets/shp/SHP-T03v1 M03v3 Here Tate, Gone Tomorrow.wav";
import brood from "../assets/shp/SHP-T04v1 M04v3 Brood and Bruder.wav";
import shpilkes from "../assets/shp/SHP-T05v1 M05v3 Shpilkes.wav";
import { useState } from "react";

function Shpilke() {
  const tracks = [
    { title: "Tokhter's Visit", track: tochter, index: "1", length: "0:44" },
    { title: "Bubbe Careful Now", track: bubbe, index: "2", length: "1:24" },
    {
    ...
    { title: "Brood and Bruder", track: brood, index: "4", length: "1:28" },
